...
# --- SAUBERES BEENDEN (TRAP) ---
cleanup() {
    echo -e "${NC}\n" # Setzt die Farbe zurück und macht einen Zeilenumbruch
    warn "Skript wurde durch den Benutzer abgebrochen."
    exit 1
}
# Fängt STRG+C (SIGINT) und Beenden (SIGTERM) ab
